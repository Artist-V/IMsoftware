...
#include "../../IMsoftware_client/widget/regwidget.h"
...
QT_MOC_LITERAL(1, 10, 12), // "do_reg_check"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 13), // "do_reg_cancel"
QT_MOC_LITERAL(4, 38, 29), // "on_confirm_pushButton_clicked"
QT_MOC_LITERAL(5, 68, 26) // "on_exit_pushButton_clicked"

    },
    "RegWidget\0do_reg_check\0\0do_reg_cancel\0"
    "on_confirm_pushButton_clicked\0"
...
void RegWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->do_reg_check(); break;
        case 1: _t->do_reg_cancel(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RegWidget::do_reg_check)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (RegWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RegWidget::do_reg_cancel)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject RegWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_RegWidget.data,
      qt_meta_data_RegWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void RegWidget::do_reg_check()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void RegWidget::do_reg_cancel()
{
